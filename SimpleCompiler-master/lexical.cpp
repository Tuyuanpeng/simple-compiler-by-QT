...
void Lexical::printf(int a) {
    ...
    case 1:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "main"));
        break;
    }
    case 2:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "return"));
        break;
    }
    case 3:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "key word"));
        break;
    }
    case 4:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "special word"));
        break;
    }
    case 5:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "number"));
        break;
    }
    case 6:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "calculator"));
        break;
    }
    case 7:
    {
    ...
    case 8:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "string"));
        break;
    }
    case 9:
    {
        RESULT.push_back(make_pair(QString::fromLocal8Bit(mid), "string line"));
        break;
    }
    default:
        break;
